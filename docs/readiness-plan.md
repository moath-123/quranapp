...
| ٣ب — iOS مع Xcode | ⏳ جزئياً | ✅ CI: البناء لـiOS (مع واجهة SwiftUI) و30 اختباراً ناجحاً على محاكي iPhone. ⏸ التطبيق المثال والتجربة اليدوية للتقليب والنقر والذاكرة بانتظار تثبيت Xcode محلياً |
