...
| ٣ب — iOS مع Xcode | ⏳ شبه مكتملة | ✅ Xcode 27 + محاكي iOS 27: تطبيق مثال (`ios/Example`) يُبنى ويعمل؛ تنزيل الصور الحقيقي 10 ثوانٍ (604 صفحة)؛ عرض الصفحات والشريط العلوي والوضع الليلي سليمة؛ الذاكرة 40 MB. ⏸ اختبار النقر والسحب يدوياً بانتظار `sudo xcode-select -s` |
...
### ما تبقّى
1. **تثبيت Xcode محلياً (المستخدم)**، ثم: تطبيق iOS مثال، وتجربة يدوية على المحاكي (التقليب، النقر، الوضع الليلي، انقطاع التنزيل)، وقياس الذاكرة.
