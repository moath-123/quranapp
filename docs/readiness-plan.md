...
روابط: [حزمة Laravel](../server/laravel-kit/README.md) · [الملاحظات](findings.md) · [تقرير أندرويد](android-test-report.md) · [تصميم iOS](ios-design.md) · [دمج iOS](integration-ios.md) · [دمج أندرويد](integration-android.md) · [Laravel](laravel-wird-api.md) · [التجربة](pilot-checklist.md) · [القرارات](decisions.md) · [الأسئلة المفتوحة](open-questions.md) · [تقرير البيانات](data-validation.md)
...
| ٥ — التجربة والإطلاق | ✅ الأدوات جاهزة · ⏳ التنفيذ عند فريق تعاهد | أحداث القياس في الـSDK، وحزمة Laravel (مفتاح الإطلاق التدريجي والإيقاف، ومزامنة الورد) بـ15 اختباراً في CI، ونمط الدمج مع الرجوع للمصحف الحالي مجرّب على المحاكي ([قائمة التجربة](pilot-checklist.md)) |
