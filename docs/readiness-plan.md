...
روابط: [الملاحظات](findings.md) · [تقرير أندرويد](android-test-report.md) · [القرارات](decisions.md) · [الأسئلة المفتوحة](open-questions.md) · [تقرير البيانات](data-validation.md)
...
| ٣ب — iOS مع Xcode | ⏳ جزئياً | CI يبني الحزمة لـiOS ويشغّل الاختبارات على محاكي iPhone؛ التطبيق المثال والتجربة اليدوية بانتظار تثبيت Xcode محلياً |
