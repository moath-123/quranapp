...
## نتائج التشغيل على المحاكي (Xcode 27، iPhone 18 Pro، iOS 27)
| الفحص | النتيجة |
|---|---|
| بناء التطبيق المثال `ios/Example` | ✅ |
| تنزيل صور الصفحات الحقيقي من Quran.com وتثبيتها | ✅ 10 ثوانٍ، 604 صفحة |
| عرض الصفحات 1 و 50 و 121 و 604 مع الشريط العلوي (السورة، الجزء، الصفحة) | ✅ |
| الوضع الليلي | ✅ |
| الذاكرة | 40 MB بعد فتح المصحف، و50 MB بعد التنزيل والتصفح |
| النقر على آية (آل عمران ٤): تظليل كل أسطرها + بطاقة النص | ✅ |
| الضغط المطوّل (آل عمران ٧، خمسة أسطر): قائمة + تظليل كامل | ✅ |
| «نسخ الآية» يضع النص الصحيح في الحافظة | ✅ |
| السحب لليمين = الصفحة التالية (50 ← 51)، ولليسار = السابقة | ✅ |
| النقر على فراغ: وضع التركيز (إخفاء الأشرطة) ثم إعادتها | ✅ |
| الفهرس: الفاتحة صفحة 1، والانتقال للأنفال (صفحة 177، الجزء 9) | ✅ |
| فشل التنزيل: رسالة عربية واضحة + زر «إعادة المحاولة»، ولا يبقى تثبيت ناقص | ✅ |
| **أُصلح أثناء الاختبار:** بطاقة الآية المختارة كانت تبقى بعد الانتقال لصفحة أخرى | ✅ |
| **أُصلح أثناء الاختبار:** رسالة الخطأ كانت تقنية بالإنجليزية | ✅ |

| التنزيل | أول صفحة | صفحة 50 | الوضع الليلي |
|---|---|---|---|
| ![](img/ios-dl.png) | ![](img/ios-p1.png) | ![](img/ios-p50.png) | ![](img/ios-dark.png) |

| النقر على آية | الضغط المطوّل | فشل التنزيل |
|---|---|---|
| ![](img/ios-tap.png) | ![](img/ios-longpress.png) | ![](img/ios-error.png) |
